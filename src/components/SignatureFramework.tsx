...
export function SignatureFramework() {
  return (
    <section id="framework" className="border-b border-border" aria-labelledby="framework-heading">
      <div className="mx-auto max-w-[1280px] px-6 lg:px-12 py-20 lg:py-28">
        <div className="grid lg:grid-cols-12 gap-12 mb-16 lg:mb-20">
          <div className="lg:col-span-5">
            ...
            <h2 id="framework-heading" className="font-display text-4xl lg:text-5xl leading-[1.02] tracking-tight">
              Enterprise AI Transformation Framework
            </h2>
            <p className="mt-6 text-lg text-muted-foreground leading-relaxed max-w-xl">
              A field-tested system for turning AI ambition into repeatable execution. Six interlocking
              disciplines — none optional — that determine whether enterprise AI becomes measurable
              business performance or permanent experimentation.
            </p>
          </div>
          <div className="lg:col-span-6 lg:col-start-7 flex items-end">
            <p className="text-lg text-muted-foreground leading-relaxed">
              Technology rarely fails in enterprise AI. Operating models do. This framework is how I
              design the connective tissue between strategy and outcomes — the same architecture
              applied across Nokia&rsquo;s R&amp;D units and company-wide enablement programs.
            </p>
          </div>
        </div>
        ...
        <div className="grid lg:grid-cols-12 gap-12 lg:gap-16 items-start border-t border-rule pt-16 lg:pt-20">
          <div className="lg:col-span-5 lg:sticky lg:top-24">
            ...
            <p className="mt-8 text-sm text-muted-foreground leading-relaxed max-w-sm">
              ...
              wastes tooling investment. Leadership without change management produces mandates, not adoption.
            </p>
          </div>
            ...
            <div className="space-y-px bg-rule">
              {pillars.map((pillar, i) => (
                <article key={pillar.id} className="bg-background p-8 lg:p-10">
                  ...
                  <h3 className="font-display text-2xl lg:text-3xl tracking-tight mb-2">{pillar.label}</h3>
        ...
        <hr className="border-0 border-t border-rule mt-16 lg:mt-20" />
        ...
        <aside className="mt-12 lg:mt-16">
          <div className="grid md:grid-cols-12 gap-8">
            ...
            <p className="md:col-span-7 md:col-start-6 text-muted-foreground leading-relaxed text-lg">
              ...
              leaders a shared language for designing the system that makes AI stick: who decides, how
              teams adopt, what gets measured, and how change propagates across decentralized segments.
            </p>
          </div>
        </aside>
      </div>
