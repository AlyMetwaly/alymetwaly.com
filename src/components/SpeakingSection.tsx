...
export function SpeakingSection() {
  return (
    <section id="speaking" className="border-b border-border bg-muted/30" aria-labelledby="speaking-heading">
      <div className="mx-auto max-w-[1280px] px-6 lg:px-12 py-20 lg:py-28">
        <div className="grid lg:grid-cols-12 gap-12 mb-16">
          <div className="lg:col-span-5">
            ...
            <h2 id="speaking-heading" className="font-display text-4xl lg:text-5xl leading-[1.02] tracking-tight">
          ...
          <div className="lg:col-span-6 lg:col-start-7 space-y-6 text-lg text-muted-foreground leading-relaxed self-end">
            <p>
              Available for keynotes, panels, roundtables, executive retreats, and leadership offsites.
              I speak to leaders who need clarity on what actually works — not what vendors promise.
            </p>
            <p>
              Talks are grounded in field experience: measurable adoption programs, governance design,
              and operating models built inside one of the world&rsquo;s most complex R&amp;D organizations.
            </p>
          </div>
        </div>
        ...
        <div className="grid lg:grid-cols-12 gap-12 lg:gap-16 border-t border-rule pt-16">
          <div className="lg:col-span-5">
            ...
            <ul className="space-y-6">
              {formats.map((format) => (
                <li key={format.label} className="grid grid-cols-[auto_1fr_1.2fr] gap-x-4 gap-y-0 text-sm border-b border-rule pb-6 last:border-0 last:pb-0 items-start">
                  <span className="text-muted-foreground/50 text-[0.5rem] mt-1.5" aria-hidden="true">○</span>
          ...
          <div className="lg:col-span-6 lg:col-start-7">
            ...
            <ul className="grid sm:grid-cols-2 gap-3">
              {topics.map((topic) => (
                <li
                  key={topic}
                  className="px-4 py-3 border border-rule bg-background text-sm leading-snug transition-colors hover:border-foreground/20 focus-within:border-foreground/20"
                >
                  {topic}
                </li>
              ))}
            ...
            <a
              ...
              className="inline-flex mt-10 px-5 py-3 rounded-full text-sm font-medium border border-border hover:bg-background"
            >
              Invite me to speak
            </a>
          </div>
