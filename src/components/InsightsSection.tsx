const articles = [
  {
    ...
    excerpt:
      "Why enterprise AI programs stall when they ship licenses instead of changing how the org decides, governs, and measures.",
    status: "Published",
  },
  {
    category: "POV",
    ...
    excerpt:
      "The structural reasons decentralized enterprises never convert experimentation into enterprise-wide practice.",
    status: "Coming soon",
  },
  {
    category: "Essay",
  ...
  },
  {
    ...
    excerpt:
      "Seats sold and prompts run are not strategy. Engineer-hours returned and portfolio maturity are.",
    status: "Coming soon",
  },
  {
    category: "POV",
  ...
  },
  {
    ...
    excerpt:
      "When leadership intent and team behavior diverge, no amount of tooling investment closes the gap.",
    status: "Coming soon",
  },
  {
    category: "Framework",
  ...
  },
  {
    ...
    excerpt:
      "Managing AI risk across business segments without building a bureaucracy that kills adoption.",
    status: "Coming soon",
  },
  {
    category: "Essay",
    ...
    excerpt:
      "How engineering organizations redesign workflows when AI becomes part of daily execution.",
    status: "Coming soon",
  },
  {
    category: "Framework",
